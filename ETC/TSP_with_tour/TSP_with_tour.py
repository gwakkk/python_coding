...
# Tour의 집합
# 여러가지 여행을 구성하고 distance와 fitness를 계산해서
# fitness가 높은것을 mutate하고 crossover하여 더 좋은 population 생성
class Population:
...
if __name__ == '__main__':
    ...
    for i in range(n_generations):
        ...
        # 가장 좋은 점수의 generation과 distance를 출력
